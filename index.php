			...
			<div class="col-md-6">
				...
				<div style="height: 250px; overflow: auto; width: 100%;">
					<table class="table table-bordered table-responsive">
						<thead>
							<tr>
								<th><i class="fa fa-user-o" aria-hidden="true"></i> Address</th>
								<th><i class="fa fa-gift" aria-hidden="true"></i> Reward</th>
								<th><i class="fa fa-clock-o" aria-hidden="true"></i> Time</th>
							</tr>
						</thead>
						<tbody> 
							<?php for ($i=0; $i <= count($his)-1; $i++) { ?>
							<tr>
								<td>
									<a href="https://faucethub.io/balance/<?=$his[$i]['to']?>" target="_blank"">
										<?=$his[$i]['to']?>
									</a>
								</td>
								<td>
